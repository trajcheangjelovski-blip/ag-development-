                  ...
                  >
                    ...
                    <div style={{ width: '180px', flexShrink: 0, display: 'flex', flexDirection: 'column' }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'baseline', gap: '2px', marginBottom: '8px' }}>
                        <span style={{ fontSize: '24px', fontWeight: 800, color: '#2563eb', display: 'inline-block', transition: 'transform 0.2s ease', transform: sel || hov ? 'scale(1.05)' : 'scale(1)' }}>${p.price}</span>
        ...
        {step === 2 && (
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: mobile ? '1fr' : '1fr 320px', gap: '24px', alignItems: 'start' }}>
              ...
              {!mobile && <div style={{ position: 'sticky', top: '80px' }}><ITSummary plan={plan} /></div>}
            </div>
